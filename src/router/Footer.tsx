...
const Footer = () => {
  return (
    <div className="h-fit w-full py-10 bg-main-gray px-10 flex md:flex-row flex-col items-center justify-between md:gap-0 gap-10">
      <div className="flex flex-col justify-center items-center md:items-start h-full w-full px-10">
        <Link to={"/home"} className='md:h-40 h-24 md:w-40 w-24 static flex items-center'>
          <div className='md:h-40 h-24 md:w-40 my-8 md:my-0 w-24 static flex items-center justify-center'>
            <div className='md:h-40 h-24 md:w-40 w-24 bg-red-600 rounded-full absolute flex items-center justify-center'>
              <img src="LogoTransparenteBlanco.png" alt="logo" className='md:h-36 h-22'/>
            </div>
          </div>
        </Link>
      </div>
